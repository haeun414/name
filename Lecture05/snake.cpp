...
int print_game_screen(int stage_width, int stage_height, int x_pos, int y_pos)
{
	int center_x = stage_width / 2;
	int center_y = stage_height / 2;
...
int main()
{
	...
	while (game_is_running)
	{
		...
		case 1:
			...
			x_pos = n1 - 1;
			y_pos= n2 - 1;
			print_game_screen(n1, n2, x_pos, y_pos);
			game_state = 5;
			break;
		case 2:
			x_pos = 0;
